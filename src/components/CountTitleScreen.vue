...
import { countState, startCountdown } from '../store/countStore'
import { ref } from 'vue'
import Modal from './Modal.vue'
import { globalState, openModal, closeModal } from '../store/globalStore'
import CountSettingsContent from './SettingsModalContent/CountSettings.vue'
...
const openSettingsModal = () => {
  openModal(CountSettingsContent)
}
