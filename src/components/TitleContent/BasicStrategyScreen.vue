...
import { state, resetBank, playRound, clearState } from '../../store/basicStrategyStore';
import { ref } from 'vue'
import Modal from '../Modal.vue'
import { globalState, openModal, closeModal } from '../../store/globalStore'
import { generateShoe } from '../../cards'
import BasicSettings from '../SettingsModalContent/BasicSettings.vue'
...
const openSettingsModal = () => {
  openModal(BasicSettings)
}
</script>

<template>
  <Modal :dialog="globalState.isOpen" :close="closeModal">
    <component :is="globalState.component" v-bind="globalState.props" />
  </Modal>
